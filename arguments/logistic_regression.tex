...
Sometimes when the datset is \textit{unbalanced} it might be a good idea to set the treshold to the relative frequence of the minority class.
...
We can resume the outcome ouf our classfier in a \textit{confusion matrix}.
\begin{figure}[h]
    \centering
