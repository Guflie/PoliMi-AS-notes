...
points in the same cluster). The \textit{t-student} instead has heavier tails, making the probability distribution more evenly spread, leveraging the dimensionality reduction
