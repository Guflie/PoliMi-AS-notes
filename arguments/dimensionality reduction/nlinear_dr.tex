...
This method family follows the idea that \textit{data might be non-linear in $\real
...
accordingly to the analyst's assumption about the shape of the feature, $\phi: \real
...
The problem with Kernel PCA is the reconstruction of the original space: with linear
