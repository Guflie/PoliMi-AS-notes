...
adding information and making the points more different from each other)}
\begin{figure}[h]
    \centering
    ...
    \begin{subfigure}[t]{0.2\textwidth}
        ...
        \includegraphics[width=0.95\linewidth]{dr/example_cd_2d_expl.png}
        {
            ...
            \caption{If we try to maintain the same density of the 1-dimension case also for the 2-d scenario , we would end up with 81 samples.}
        }
    \end{subfigure}
\end{figure}
...
we had to use more complex (non linear) models.
\begin{figure}[h]
    \centering
...
the number of samples goes to infinity, the relative distances between datapoints tend to 
become zero, starting to concentrate to the expected value.
\begin{figure}[h]
    \centering
