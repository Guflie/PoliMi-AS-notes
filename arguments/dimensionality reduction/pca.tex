...
It means that some fatures might look somethign completely different, but in 
...
By switching to th Lagrangian relaxation:
\begin{equation}
...
So as principal component we take the eigenvector with the highest eigenvalue.
...
\end{figure}
This technique can be used also to other purposes that only tune the variance
level, can be used also to set the treshold to remove the noise from the data.

\subsubsection{How to interpret PCs}
The weight values can be used to interpret the meaning of the PCs.
\begin{figure}
    \centering
...
Another useful way to interpret the PCs' meaning is the \textbf{biplot}: using
